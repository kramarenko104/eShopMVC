...
CREATE TABLE IF NOT CREATE DATABASE IF NOT EXISTS eshopdb CHARACTER SET utf8 COLLATE utf8_general_ci;
USE eshopdb;
...
create index FK2n2rk9lxbe0vnin36whtithi2
	on carts_products (productId);
...
create index FK6co8q7ko456baksb6tdjq2dfv
	on orders (userId);
...
create index FKexx6ud6v30pcvsvsduojigvhf
	on orders_products (productId);
